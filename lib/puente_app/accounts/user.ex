defmodule PuenteApp.Accounts.User do
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, PuenteApp.Repo)
  ...
  """
  def valid_password?(%PuenteApp.Accounts.User{hashed_password: hashed_password}, password)
